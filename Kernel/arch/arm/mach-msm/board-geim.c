...
/* SS_BLUETOOTH(taekyu.shin) 2012.03.14 */
//[P120228-0781] add blocking code by qualcomm(SR 00728989) 
	if ((int)version < 0 || version == BAHAMA_VER_UNSUPPORTED || version > BAHAMA_VER_2_0) { 
...
static struct msm_i2c_platform_data msm_gsbi0_qup_i2c_pdata = {
	...
	.clk			= "gsbi_qup_clk",
	.pclk			= "gsbi_qup_pclk",
	.pri_clk = 60, // test code for I2C recovery 
	.pri_dat = 61, // test code for I2C recovery 
...
static struct msm_i2c_platform_data msm_gsbi1_qup_i2c_pdata = {
	...
	.clk			= "gsbi_qup_clk",
	.pclk			= "gsbi_qup_pclk",
	.pri_clk = 131, // test code for I2C recovery 
	.pri_dat = 132, // test code for I2C recovery 
	.msm_i2c_config_gpio	= gsbi_qup_i2c_gpio_config,
};
...
*/
	...
	static unsigned int kp_col_gpios[] = {31};
	static unsigned int kp_wakeup_gpios[] = {};
	static const unsigned short keymap[ARRAY_SIZE(kp_col_gpios) *
					  ARRAY_SIZE(kp_row_gpios)] = {
